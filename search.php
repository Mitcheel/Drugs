<!--esto no funciona y estoy haciendo un test de git hub push-->

<?php $filename=basename(__FILE__, '.php'); ?>
<?php if (isset($_GET[ "dtq"])) {
  $unwanted_array=array( 'Š'=>'S', 'š'=>'s', 'Ž'=>'Z', 'ž'=>'z', 'À'=>'A', 'Á'=>'A', 'Â'=>'A', 'Ã'=>'A', 'Ä'=>'A', 'Å'=>'A', "Æ"=>'A', 'Ç'=>'C', 'È'=>'E', 'É'=>'E', 'Ê'=>'E', 'Ë'=>'E', 'Ì'=>'I', 'Í'=>'I', 'Î'=>'I', 'Ï'=>'I', 'Ñ'=>'N', 'Ò'=>'O', 'Ó'=>'O', 'Ô'=>'O', 'Õ'=>'O', 'Ö'=>'O', 'Ø'=>'O', 'Ù'=>'U', 'Ú'=>'U', 'Û'=>'U', 'Ü'=>'U', 'Ý'=>'Y', 'Þ'=>'B', 'ß'=>'Ss', 'à'=>'a', 'á'=>'a', 'â'=>'a', 'ã'=>'a', 'ä'=>'a', 'å'=>'a', 'æ'=>'a', 'ç'=>'c', 'è'=>'e', 'é'=>'e', 'ê'=>'e', 'ë'=>'e', 'ì'=>'i', 'í'=>'i', 'î'=>'i', 'ï'=>'i', 'ð'=>'o', 'ò'=>'o', 'ó'=>'o', 'ô'=>'o', 'õ'=>'o', 'ö'=>'o', 'ø'=>'o', 'ù'=>'u', 'ú'=>'u', 'û'=>'u', 'ý'=>'y', 'þ'=>'b', 'ÿ'=>'y' );
  $dtq = $_GET["dtq"]; $dtq = strtr( $dtq, $unwanted_array ); } else {
    $dtq = "";
  } ?>
<?php include ("conexion.php"); header( 'Content-Type: text/html, charset=utf-8'); ?>
<style>
  ...
  <div class="loader">
   ...
   <!--  <?php /*include ( "header.php");*/ ?> -- >
    ...
    <table id=searchResults class="display table table-responsive">
        <?php $data=searchResults($conexion, "");
        echo '
          <thead>
            <th>id_referencia</th>
            <th>descripcion</th>
            ...
            <tr>
              <td>
                <a href="view.php?action=viewEntry&id='.$key[ "id_referencia"]. '">'.$key[ "medicamentos"]. '</a>
              </td>
              <td>
                '.$key[ "proveedor"]. '
              </td>
